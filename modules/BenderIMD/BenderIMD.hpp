...
#ifndef BENDER_IMD_HPP
#define BENDER_IMD_HPP
...
class BenderIMD : public Everest::ModuleBase {
public:
    BenderIMD() = delete;
    BenderIMD(const ModuleInfo& info, std::unique_ptr<isolation_monitorImplBase> p_main,
    ...
    /// @brief Remember whether the measurement is active or not
    std::atomic_bool started {false};

    /// @brief Our controller instance which abstracts the Modbus interface
    BenderIMDController controller;
    // ev@1fce4c5e-0ab8-41bb-90f7-14277703d2ac:v1
