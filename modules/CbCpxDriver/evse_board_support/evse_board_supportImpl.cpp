...
void evse_board_supportImpl::init() {
    ...
    this->mod->controller->on_cpx_timeout.connect([&](bool timeout) {
        ...
        if (timeout == true) {
            ...
            Everest::error::Error error_object = this->error_factory->create_error(
                error_type, "", errmsg.str(), Everest::error::Severity::High);
            this->raise_error(error_object);
        } else {
...
void evse_board_supportImpl::raise_contactor_error(const std::string& source, bool desired_state, types::cb_board_support::ContactorState actual_state) {
