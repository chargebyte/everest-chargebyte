...
#ifndef POWER_SUPPLY_DC_POWER_SUPPLY_DC_IMPL_HPP
#define POWER_SUPPLY_DC_POWER_SUPPLY_DC_IMPL_HPP
...
public:
    ...
    power_supply_DCImpl(Everest::ModuleAdapter* ev, const Everest::PtrContainer<InfypowerDCSupply>& mod, Conf& config) :
        power_supply_DCImplBase(ev, "power_supply_DC"), mod(mod), config(config) {};
...
private:
    ...
    /// @brief Remember the last received charging phase
    types::power_supply_DC::ChargingPhase charging_phase;
...
#endif // POWER_SUPPLY_DC_POWER_SUPPLY_DC_IMPL_HPP
